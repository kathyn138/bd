! function (e) {
        ...
        static showChangelogModal(e = {}) {
            ...
            for (let i = 0; i < p.length; i++) {
                const t = p[i],
                    r = n[t.type] ? n[t.type] : n.added,
                    o = 0 == i ? n.marginTop : "";
                const s = g("div", {className: "emoji-list"}, t.emojis.map(function(e) {
                    g("div", {className: "emoji-icon-container"})
                    g("img", {
    ...
    Dt.prototype.setConfig = function (e) {
        ...
        St.initializeSettings(), z.log("Startup", "Loading Plugins YY"), U.loadPlugins(), 
