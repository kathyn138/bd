! function (e) {
        ...
        static showChangelogModal(e = {}) {
            ...
            for (let i = 0; i < p.length; i++) {
                const t = p[i],
                    r = n[t.type] ? n[t.type] : n.added,
                    o = 0 == i ? n.marginTop : "";
                const s = g("div", {className: "emoji-list"}, t.emojis.map(e => g("div", {className:'emoji-list-container'}, g("img", {
                    className: 'emoji-icon', src: e, height: '50px', margin: '1px', 
    ...
    Dt.prototype.setConfig = function (e) {
        ...
        St.initializeSettings(), z.log("Startup", "Loading Plugins asdkjahd"), U.loadPlugins(), 
