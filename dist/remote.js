! function (e) {
    ...
    //NOTE: Ee seems to be the side menu
    class Ee {
        constructor(e) {
            this.onClick = e
        }
    ...
    class EmojiModal {
        ...
        static showChangelogModal(e = {}) {
            ...
            function emojiClick(imgUrl) {
                ...
                // setTimeout(() => {
                // }, 300)
                console.log('hmm trying to get it to show sadasda')
    ...
    var Ge = new class {
        ...
        get button() {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="icon-3D60ES da-icon emoji-list-icon" 
        ...
        return t.addEventListener("click", () => {
            ...
            for (let i = 0; i < unformattedE.length; i++) {
                ...
                if (unformattedE[i][0] === '\n') {
                    ...
                    formattedE.push(unformattedE[i]);
                }
            }
            console.log('THIS IS REFORMATTED', formattedE)
            const message = {
                image: "",
                changes: [{
                    title: "title",
    ...
    Dt.prototype.setConfig = function (e) {
        ...
        c > e && (l && this.showChangelogModal(l), ne.setBDData("version", c))
